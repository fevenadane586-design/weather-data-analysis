...
A Python-based data analysis project that processes and visualizes weather data to identify temperature trends, calculate average temperature, and detect the hottest and coldest days refactored into an **object-oriented design** for better maintainability and scalability.
